...
export default function MentorsPage() {
  ...
  const getdata = async () => {
    try {
      let listdata = await axios.get("https://64ec4e09f9b2b70f2bfa11de.mockapi.io/mentors");
      // message.success("Fetched Mentors Data");
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`https://64ec4e09f9b2b70f2bfa11de.mockapi.io/mentors/${id}`);
  ...
  const getProducts = async (id) => {
    let singledata = await axios.get(`https://64ec4e09f9b2b70f2bfa11de.mockapi.io/mentors/${id}`)
